...
"""
Linear/DLinear models are re-implemented using Neural Forecast Libary: https://github.com/Nixtla/neuralforecast
"""
...
class LinearModels:
    ...
    def runDLinear(self):
        """
        Runs the DLinear model and computes metrics.
        Returns:
            DataFrame: Metrics for the DLinear model.
        """
        model = DLinear(
            h=self.output_length,
            input_size=2 * self.output_length,
    ...
    def _generate_results(self, nf):
        ...
        Args:
            ...
            every time - each test set must have the same input length
        Returns:
